...
export function FloatingChatbot() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "1",
      text: "Hi! I'm your AI assistant for real-time bracket syntax validation. I help explain stack-based matching, errors, and fixes.",
    ...
    <>
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <div className="relative h-full bg-card border rounded-2xl shadow-xl flex flex-col">
              {/* Header */}
